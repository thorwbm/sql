...
alter PROCEDURE SP_COMPARAR_TABELAS_CAMPO_A_CAMPO  
...
SET @SQL2 = N'SELECT DISTINCT TAB2.*, TABELA = ' + CHAR(39) + @TAB2 + CHAR(39) + ' FROM ' + @TAB1 + ' AS TAB1 WITH(NOLOCK) RIGHT JOIN ' + @TAB2 + ' AS TAB2 WITH(NOLOCK) ON ( ' 
SET @CAMPOS_SQL = N''
