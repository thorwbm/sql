...
set @titulo  = 'FN_DATA_PTBR'
SET @TEXTO   = ' FUNCAO QUE RECEBE UMA DATA E UM SEPARADOR  E RETORNA UM UMA STRING COM A DATA NO FORMATO DD(SEPARADOR)MM(SEPARADOR)YYYY HH:MM:SS:mmm '
SET @TEXTO   = @TEXTO + '' 
SET @TEXTO   = @TEXTO + '' 
SET @TEXTO   = @TEXTO + '' 
SET @TEXTO   = @TEXTO + '' 
